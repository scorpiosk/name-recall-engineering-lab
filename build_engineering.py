...
for marker, source in [('ENGINEERING_CSS', (ROOT / 'engineering.css').read_text() + '\n' + (ROOT / 'studio.css').read_text()), ('MODEL_PAYLOAD', model_code), ('MODEL_ENGINE', engine), ('ENGINEERING_CORE', core), ('ENGINEERING_UI', ui), ('TRAINING_ENGINE', training_engine), ('TRAINING_WORKER', worker_source), ('STUDIO_UI', (ROOT / 'studio-ui.js').read_text())]:
